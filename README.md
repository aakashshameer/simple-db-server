...
**Part 1 due: Tuesday, April 4th 11:00PM**

**Due: Wednesday, April 12th 11:00 PM**
...
```sh
$ git clone git@gitlab.cs.washington.edu:cse444-23sp/simple-db-MY_GITLAB_USERNAME.git
...
$ git remote add upstream git@gitlab.cs.washington.edu:cse444-23sp/simple-db.git
```
...
```sh
$ git remote -v
  origin  git@gitlab.cs.washington.edu:cse444-23sp/simple-db-username.git (fetch)
  origin  git@gitlab.cs.washington.edu:cse444-23sp/simple-db-username.git (push)
  upstream    git@gitlab.cs.washington.edu:cse444-23sp/simple-db.git (fetch)
  upstream    git@gitlab.cs.washington.edu:cse444-23sp/simple-db.git (push)
```
...
Let's test out the origin remote by doing a push of your main branch to GitLab. Do this by issuing the following commands:
...
To git@gitlab.cs.washington.edu:cse444-23sp/simple-db-username.git
...
From gitlab.cs.washington.edu:cse444-23sp/simple-db
...
After executing the `turnInLab.sh` script, make sure to check your repository on GitLab to ensure that the tag has been property applied!  You may do this by visiting `https://gitlab.cs.washington.edu/cse444-23sp/simple-db-YOUR_USERNAME/tags`.
...
To git@gitlab.com:cse444-23sp/hw-answers-pirateninja.git
 - [deleted]         lab1
...
```sh
$ git clone git@gitlab.cs.washington.edu:cse444-23sp/simple-db-username.git confirmation_directory
